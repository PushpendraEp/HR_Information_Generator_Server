...
// Deepak (13/03/2023) parsing emp_id,selected month and year from query params
  ...
  connection.query(sql, (error, results) => {
    if (error) {
      ...
      // @ Deepak (10/04/2023) getting data from database
      ...
      //@ Deepak (10/04/2023) Get the width and height of the page
      const pageWidth = doc.page.width;
      const pageHeight = doc.page.height;

     // @ Deepak (10/04/2023) adding company logo at top of PDF file
      ...
      //@ Deepak (10/04/2023) Define the positions for each column in the table
      const col1X = 60;
      const col2X = 230;
      const col3X = 300;
      const col4X = 450;

      // @ Deepak (10/04/2023) set header line of PDF file
      ...
      //@ Deepak (10/04/2023) Define the height and vertical position of the table
      const tableHeight = 6 * 20; // 7 rows of height 20
      const tableY = (pageHeight - tableHeight) / 3.2;

      //@ Deepak (10/04/2023) Add the column headers
      ...
      //@ Deepak (10/04/2023) Add the rows for the table
      ...
      //@ Deepak (10/04/2023) Set the border of the table
      doc.rect(50, 220, 500, 320).lineWidth(1).stroke();

      //@ Deepak (10/04/2023) Add vertical lines inside the table
      ...
      //@ Deepak (10/04/2023) Add horizontal lines inside the table
      ...
      doc.moveDown(8.3);
      //@ Deepak (10/04/2023) Add the footer lines in the PDF file
      ...
      doc.end();
      // Deepak (13/03/2023) checking error while sending pdf file response
      fileStream.on('error', () => {
        res.status(404).send('File not found');
      });
      fileStream.on('open', () => {
        // Deepak (13/03/2023) sending response to client side in the PDF file
        res.status(200)
      ...
      fileStream.on('finish', () => {
        // @ Deepak (10/04/2023) Delete the generated file from the internal storage
...
// @ Deepak (10/04/2023) created a function to convert number to word
function convert(num) {
  const ones = ['', 'One', 'Two', 'Three', 'Four', 'Five', 'Six', 'Seven', 'Eight', 'Nine'];
  const tens = ['', '', 'Twenty', 'Thirty', 'Forty', 'Fifty', 'Sixty', 'Seventy', 'Eighty', 'Ninety'];
  const scales = ['', 'Thousand', 'Lakh', 'Crore'];
  const numWords = [];
  // @ Deepak (10/04/2023) checking number value to get return 
  if (num === 0) {
    return 'Zero Rupees';
  }
  if (num < 0) {
